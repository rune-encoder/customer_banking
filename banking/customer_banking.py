...
def main():
    ...
    savings_maturity = int(input("MONTHS???")) #! REVISIT
    ...
    print("IE", interest_earned, "usavings", updated_savings_balance)
    ...
    print("IE", interest_earned, "usavings", updated_cd_balance)
